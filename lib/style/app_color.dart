...
class AppColor {
  ...
  static const Color primary = Color(0xFFAE511A);
  static Color appBarColor = Color(0xFF528986);
  static Color buttonColor = Color(0xFF958A53);

  static Color primarySoft = Color(0xFF404237);

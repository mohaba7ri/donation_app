...
//                                           pw.TextSpan(
//                                             text:
//                                                 'بئر / المهدية بنت مهدي رحمها الله – بنوة بنت عكشان رحمها الله – مفرح ناصر جميله بنت مفرح رحمها الله – ناصر بن حمد رحمه الله ',
//                                             style: pw.TextStyle(
//                                                 font: ttf,
//                                                 fontSize:
...
//                                           pw.TextSpan(
//                                             text:
//                                                 ' دينار كويتي (فقط ستمائة وخمسة دنانير كويتي لا غير )',
//                                             style: pw.TextStyle(
//                                                 font: ttf,
//                                                 fontSize:
//                                                     9), // Custom font for text
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Arabic PDF Report Example'),
//       ),
//       body: Center(
...
//             // Handle PDF based on the platform
//             if (!kIsWeb) {
...
//                 ..setAttribute('download', 'example_report.pdf')
//                 ..click();
...
//             backgroundColor:
//                 Colors.amber[800], // Change this to your desired button color
